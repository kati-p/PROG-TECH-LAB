...
public class Course {
    ...
    public Course(String name, String id){
        this.name = name; this.id = id; credit = 3;
    }
    /**
     * 
     * @param name
    ...
    public int compare(Course c){
        ...
        if (eN && eID && eC) return 0;
        else if (eN && !eID && eC) return 1;
        else if (!eN && eID && eC) return 2;
        else if (eN && eID && !eC) return 3;
        else if (!eN && eID && !eC) return 4;
        else if (eN && !eID && !eC) return 5;
        else if (!eN && !eID && eC) return 6;
        else return 7;       
    }
    /**
     * 
